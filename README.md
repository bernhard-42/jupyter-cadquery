...
- **Create a conda environment with Jupyterlab:**
    ...
    - Download the environment definition files:
        ...
        ```bash
        wget https://raw.githubusercontent.com/bernhard-42/jupyter-cadquery/v0.9.2/environment.yml
        wget https://raw.githubusercontent.com/bernhard-42/jupyter-cadquery/v0.9.2/labextensions.txt
        ```
...
- Build docker image
    ...
    ```bash
    cd docker
    IMAGE=bernhard-42/jupyter-cadquery:0.9.2
