...
1. **Using conda**
   ...
   - Create a conda environment with Jupyterlab:
     ...
     - Install _Jupyter-CadQuery_ (note, matplotlib is only used for the examples)
       ...
       ```bash
       pip install jupyter-cadquery==3.0.0rc2 matplotlib
       ```
...
2. **Using a docker image**
   ...
   - Run _Jupyter-CadQuery_ in **JupyterLab**
     ...
     docker run -it --rm -v $WORKDIR:/home/cq -p 8888:8888 bwalter42/jupyter_cadquery:3.0.0rc2
     ```
     ...
     - To start with examples, you can
       - omit the volume mapping and just run `docker run -it --rm -p 8888:8888 bwalter42/jupyter_cadquery:3.0.0rc2` or
   ...
   - Run _Jupyter-CadQuery_ as **standalone viewer**
     ...
     ```bash
     docker run -it --rm -p 8888:8888 -p 5555:5555 bwalter42/jupyter_cadquery:3.0.0rc2 -v [-d]
     ```
